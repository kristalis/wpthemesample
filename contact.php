			...
			<form action="" method="post" class="avada-contact-form">
				...
				<div id="comment-input">
					...
					<div id="comment-textarea" class="fusion-contact-comment-below">
						<textarea name="msg" id="comment" cols="10" rows="4" class="textarea-comment" placeholder="<?php esc_attr_e( 'Message', 'Avada' ); ?>" aria-label="<?php esc_attr_e( 'Message', 'Avada' ); ?>"><?php echo esc_textarea( $avada_contact->message ); // WPCS: CSRF ok. ?></textarea>
					</div>
				<?php endif; ?>
				</div>

      ...
      <div class="fusion-flyout-menu-icons">
        ...
        if (class_exists('WooCommerce') && Avada()->settings->get('woocommerce_cart_link_main_nav')) {
          ...
          <div class="fusion-flyout-cart-wrapper">
            <a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>" class="fusion-icon fusion-icon-shopping-cart<?php echo $cart_link_class; ?>">
              <?php echo $cart_link_text; ?>
            </a>
          </div>
        <?php } ?>
